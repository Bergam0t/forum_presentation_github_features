...
Code snippets are a handy way to shorten the process of entering repetitive code.
...
We will now be presented with a list of possible snippets.

If working with Quarto, I'd recommend you use 'markdown' rather than 'Quarto', as then there's a neat little shortcut in VSCode we can use
to
