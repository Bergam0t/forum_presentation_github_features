...
Feed it your function, tell it your preferred docstring format (I like numpydoc), et voila!

This can save a lot of time with functions with extensive inputs
...
Using the 'book' template, you can write a detailed
...
It's a bit more tricky to get started with than pure quarto (and is something you could look to incorporate at a later stage)
...
The documentation for my package vidigi is made using quarto + quartodoc - https://bergam0t.github.io/vidigi/vidigi_docs/
...
It also generates an overview of the functions you ask it to
...
## Getting started with quartodoc and sphinx
...
There are a wide range of checklists out there for helping you ensure your code is up to scratch.
